...
async function syncAll() {
  ...
  const allFieldDefs = {
    ...
    'home.programs': [
      { name: 'badge', label: 'Section Badge', field_type: 'short_text', value: 'PRACTICAL CAREER TRACKS', sort_order: 1 },
      { name: 'heading', label: 'Main Heading', field_type: 'heading', value: 'Choose Your Learning Path.', sort_order: 2 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'Comprehensive, mentor-led programs designed to build high-income digital skills.', sort_order: 3 }
    ],
    'home.career_journey': [
      { name: 'badge', label: 'Section Badge', field_type: 'short_text', value: 'CAREER BLUEPRINT', sort_order: 1 },
      { name: 'heading', label: 'Main Heading', field_type: 'heading', value: 'Your Path to a Creative Career.', sort_order: 2 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'A structured 5-step milestone journey from zero experience to a thriving creative career.', sort_order: 3 }
    ],
    'home.skill_stack': [
      { name: 'badge', label: 'Section Badge', field_type: 'short_text', value: 'TOOL MASTERY', sort_order: 1 },
      { name: 'heading', label: 'Main Heading', field_type: 'heading', value: 'Master the Industry Standard Tools.', sort_order: 2 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'Hands-on practical training with the most demanded creative and AI software.', sort_order: 3 }
    ],
    'home.certifications': [
    ...
    'home.learner_stories': [
      ...
      { name: 'heading', label: 'Heading', field_type: 'heading', value: 'Real People, Real Transformations.', sort_order: 2 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'Watch how our students turned their passion for design and video editing into high-income freelance careers and job offers.', sort_order: 3 }
    ],
    'home.community': [
      { name: 'badge', label: 'Badge', field_type: 'short_text', value: 'TAMIL NADU CREATORS CLUB', sort_order: 1 },
      { name: 'heading', label: 'Heading', field_type: 'heading', value: "You Don't Have to Learn Alone.", sort_order: 2 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'Join the Tamil Nadu Creators Club — a thriving community of designers, creators, and digital professionals learning, sharing, and growing together.', sort_order: 3 },
      { name: 'cta_button_text', label: 'Button Text', field_type: 'short_text', value: 'Join the Community →', sort_order: 4 },
      { name: 'cta_button_url', label: 'Button URL', field_type: 'url', value: 'https://tamilnaducreatorsclub.com/', sort_order: 5 },
      { name: 'stat_members', label: 'Members Stat', field_type: 'short_text', value: '40K+ Community Members', sort_order: 6 },
      { name: 'stat_workshops', label: 'Workshops Stat', field_type: 'short_text', value: '100+ Workshops Held', sort_order: 7 },
      { name: 'stat_students', label: 'Students Stat', field_type: 'short_text', value: '5K+ Students Trained', sort_order: 8 },
    ],
    'home.testimonials': [
    ...
    'home.cta': [
      { name: 'heading', label: 'Main Heading', field_type: 'heading', value: 'Your Next Chapter Starts Here.', sort_order: 1 },
      { name: 'description', label: 'Description', field_type: 'long_text', value: 'Learn practical digital skills. Build real projects. Create your future — in Tamil.', sort_order: 2 },
      { name: 'primary_button_text', label: 'Primary Button Text', field_type: 'short_text', value: 'Explore Courses', sort_order: 3 },
      { name: 'primary_button_url', label: 'Primary Button URL', field_type: 'url', value: '/programs', sort_order: 4 },
      { name: 'secondary_button_text', label: 'Secondary Button Text', field_type: 'short_text', value: 'Join TNCC Community →', sort_order: 5 },
      { name: 'secondary_button_url', label: 'Secondary Button URL', field_type: 'url', value: 'https://tamilnaducreatorsclub.com/', sort_order: 6 }
    ],
    'about.hero': [
