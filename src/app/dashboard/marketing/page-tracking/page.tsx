...
import PageTrackingManagerClient from '@/components/marketing/PageTrackingManagerClient'

export default async function PageTrackingPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      <PageTrackingManagerClient initialRules={initialRules} />
    </div>
  )
}
